...
from apps.placas.serializers.propietario import PropietarioSerializers
...
class PropietarioViewSet(viewsets.ModelViewSet):
    ...
    def retrieve(self, request, *args, **kwargs):
        #Sobrescribe el método RETRIEVE (GET /propietarios/pk/)
        try:
            ...
            return Response(
                {
                    "error": f"El propietario no existe"
                },
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            try:
                ...
                propietarios = self.get_queryset()
                lista_serializer = self.get_serializer(propietarios, many=True)
            ...
            return Response(
                {
                    "message": "Hubo un error al crear el propietario",
    ...
    def update(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            return Response(
                {
                    "message": "Hubo un error al actualizar el propietario",
                    "error": serializer.errors
                },
                status=status.HTTP_400_BAD_REQUEST
            )
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        try:
            ...
            #Retorno toda la lista de propietarios.
            propietarios = self.get_queryset()
