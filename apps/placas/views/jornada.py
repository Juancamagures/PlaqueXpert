...
from apps.placas.serializers.jornada import JornadaSerializers
...
class JornadaViewSet(viewsets.ModelViewSet):
    ...
    def retrieve(self, request, *args, **kwargs):
        #Sobrescribe el método RETRIEVE (GET /jornadas/pk/)
        try:
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            try:
                ...
                jornadas = self.get_queryset()
                lista_serializer = self.get_serializer(jornadas, many=True)
            ...
            return Response(
                {
                    "message": "Hubo un error al crear el jornada",
    ...
    def update(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            return Response(
                {
                    "message": "Hubo un error al actualizar el jornada",
                    "error": serializer.errors
                },
                status=status.HTTP_400_BAD_REQUEST
            )
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        try:
            ...
            #Retorno toda la lista de jornadas.
            jornadas = self.get_queryset()
