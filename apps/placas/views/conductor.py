...
from apps.placas.serializers.conductor import ConductorSerializers
...
class ConductorViewSet(viewsets.ModelViewSet):
    ...
    def retrieve(self, request, *args, **kwargs):
        #Sobrescribe el método RETRIEVE (GET /conductor/pk/)
        try:
            ...
            return Response(
                {
                    "error": f"El conductor no existe"
                },
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            try:
                ...
                conductores = self.get_queryset()
                lista_serializer = self.get_serializer(conductores, many=True)
            ...
            return Response(
                {
                    "message": "Hubo un error al crear el conductor",
    ...
    def update(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            return Response(
                {
                    "message": "Hubo un error al actualizar el conductor",
                    "error": serializer.errors
                },
                status=status.HTTP_400_BAD_REQUEST
            )
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        try:
            ...
            #Retorno toda la lista de conductores.
            conductores = self.get_queryset()
