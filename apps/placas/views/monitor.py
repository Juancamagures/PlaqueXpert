...
from apps.placas.serializers.monitor import MonitorSerializers
...
class MonitorViewSet(viewsets.ModelViewSet):
    ...
    def retrieve(self, request, *args, **kwargs):
        #Sobrescribe el método RETRIEVE (GET /Monitores/pk/)
        try:
            ...
            return Response(
                {
                    "error": f"El movimiento no existe"
                },
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            try:
                ...
                monitores = self.get_queryset()
                lista_serializer = self.get_serializer(monitores, many=True)
    ...
    def update(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            return Response(
                {
                    "message": "Hubo un error al actualizar el monitor",
                    "error": serializer.errors
                },
                status=status.HTTP_400_BAD_REQUEST
            )
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        try:
            ...
            #Retorno toda la lista de monitores.
            monitores = self.get_queryset()
