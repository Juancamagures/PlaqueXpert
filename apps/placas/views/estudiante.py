...
from apps.placas.serializers.estudiante import EstudianteSerializers
...
class EstudianteViewSet(viewsets.ModelViewSet):
    ...
    def retrieve(self, request, *args, **kwargs):
        #Sobrescribe el método RETRIEVE (GET /estudiantes/pk/)
        try:
            ...
            return Response(
                {
                    "error": f"El estudiante no existe"
                },
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            try:
                ...
                lista_serializer = self.get_serializer(estudiantes, many=True)
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        try:
            ...
            #Retorno toda la lista de estudiantes.
            estudiantes = self.get_queryset()
