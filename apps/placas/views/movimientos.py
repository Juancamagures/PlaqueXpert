...
from apps.placas.serializers.movimientos import MovimientoSerializers
...
class MovimientoViewSet(viewsets.ModelViewSet):
    ...
    def retrieve(self, request, *args, **kwargs):
        #Sobrescribe el método RETRIEVE (GET /movimientos/pk/)
        try:
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            try:
                ...
                lista_serializer = self.get_serializer(movimientos, many=True)
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        try:
            ...
            #Retorno toda la lista de movimientos.
            movimientos = self.get_queryset()
            ...
            return Response(
                {
                    "error": f"El movimientos no existe"
                },
                status=status.HTTP_404_NOT_FOUND
            )
